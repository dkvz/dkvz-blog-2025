    ...
    <div id="menu">
      <nav class="menu">
        ...
        <div class="menu__socials">
          <a href="#" title="Mon compte Twitter"><svg class="socials" viewBox="0 0 512 512">
              <path
          ...
          <a href="#" title="Mon compte Github"><svg class="socials" viewBox="0 0 496 512">
              <path
...
appearance="toggle" permanent></dark-mode-toggle>-->
  ...
  <footer>
    <div class="footer">
      ...
      <img src="~/assets/img/gillescut_300.png" alt="Test Image 2">
    </div>
  </footer>
</template>
